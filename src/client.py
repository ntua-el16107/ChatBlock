...
def client():
    ...
    while True:
        ...
        if method_a == 'new transaction':
            ...
            confirmation_q = [
                {
                    'type': 'confirm',
                    'name': 'confirm',
                    'message': 'Do you want to send ' + str(transaction_a["amount"]) + ' BBCs to node ' + str(transaction_a["receiver"]) + '?',
                    'default': False
                }
            ]
            ...
            print(
                "  id of the node to which you want to send the BBCs and the amount of BBCs")
            print("  to send.")
            print(
